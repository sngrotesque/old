...
def happyNewYear(srd_img_file_path, dst_img_file_path = None, scale = 2, sample_step = 3):
    ...
    #创建绘制对象
    font = ImageFont.truetype("consola.ttf", 10, encoding="unic")    # font = ImageFont.truetype('simsun.ttc', 10)
    char_table = list('%&@#')   # 填充的字符内容
...
happyNewYear("input_file.jpg", "output_file.jpg")
#input_file.jpg为源文件，output_file.jpg为输出文件
